...
public class TushuLiuyanController {
    ...
    private static final String TABLE_NAME = "tushuLiuyan";
    ...
    */
    ...
    public R update(@RequestBody TushuLiuyanEntity tushuLiuyan, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,tushuLiuyan:{}",this.getClass().getName(),tushuLiuyan.toString());
        TushuLiuyanEntity oldTushuLiuyanEntity = tushuLiuyanService.selectById(tushuLiuyan.getId());//查询原先数据
...
//            tushuLiuyan.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<TushuLiuyanEntity> oldTushuLiuyanList =tushuLiuyanService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            tushuLiuyanEntity.setUpdateTime(sdf.parse(data.get(0)));          //回复时间 要改的
