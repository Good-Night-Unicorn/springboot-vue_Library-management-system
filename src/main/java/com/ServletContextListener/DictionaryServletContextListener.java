...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if (myThreadMethod == null) {
            ...
            YonghuService yonghuService = (YonghuService)appContext.getBean("yonghuService");
            TushuOrderService tushuOrderService = (TushuOrderService)appContext.getBean("tushuOrderService");

            myThreadMethod.setYonghuService(yonghuService);
            myThreadMethod.setTushuOrderService(tushuOrderService);
