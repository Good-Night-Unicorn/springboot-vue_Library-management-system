...
var centerMenu = [
    ...
    ,{
        name: '图书收藏',
        url: '../tushuCollection/list.html'
    }
    ,{
        name: '图书借阅',
        url: '../tushuOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '图书',
        url: './pages/tushu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/tushujieyueguanlixitong/admin/dist/index.html#/login";
