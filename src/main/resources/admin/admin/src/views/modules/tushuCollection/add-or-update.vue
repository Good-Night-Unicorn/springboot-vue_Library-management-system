    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="tushuCollectionTypes">
                        <el-select v-model="ruleForm.tushuCollectionTypes" :disabled="ro.tushuCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in tushuCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="tushuCollectionValue">
                        <el-input v-model="ruleForm.tushuCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    tushuId: false,
                    yonghuId: false,
                    tushuCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    tushuId: '',
                    yonghuId: '',
                    tushuCollectionTypes: '',
                    insertTime: '',
                },
                tushuCollectionTypesOptions : [],
                tushuOptions : [],
                yonghuOptions : [],
                rules: {
                   tushuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tushu_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tushuCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`tushuCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.tushuCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
